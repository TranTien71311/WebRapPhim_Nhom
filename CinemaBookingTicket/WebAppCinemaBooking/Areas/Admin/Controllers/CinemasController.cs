...
namespace WebAppCinemaBooking.Areas.Admin.Controllers
{
    ...
    public class CinemasController : Controller
    {
        ...
        {
            ViewData["Manager_ID"] = new SelectList(_context.Stafs, "ID", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Address,Hotline,Status,Manager_ID")] Cinema cinema)
        {
            ...
            ViewData["Manager_ID"] = new SelectList(_context.Stafs, "ID", "Avatar", cinema.Manager_ID);
            return View(cinema);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["Manager_ID"] = new SelectList(_context.Stafs, "ID", "Name", cinema.Manager_ID);
            return View(cinema);
        }
